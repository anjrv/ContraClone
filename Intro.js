...
<<<<<<< HEAD
    ...
    if (white) {
        ...
        if (inShop) setTimeout(function() {mainShop.drawShop(); }, 0);
        return;
    }
...
function checkInputs() {
    ...
    // Increase Base Lives
    if (inShop && s_menuSelection === 0 && (eatKey(KEY_SHOOT) || eatKey(KEY_JUMP)) && s_baseLives !== s_livesMax && !(s_coins < s_baseLives * 150)) {
    ...
    // Increase Fire Rate
    if (inShop && s_menuSelection === 1 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_fireRate === 10) && !(s_coins < s_fireRatio * 500)) {
    ...
    // Fire powerup
    if (inShop && s_menuSelection === 2 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 1000)) {
        s_coins -= 1000;
        s_firePowerup = true;
        s_noPowerup = false;
    ...
    // Triple Shot
    if (inShop && s_menuSelection === 3 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 1000)) {
        s_coins -= 1000;
        s_firePowerup = false;
        s_noPowerup = false;
        s_piercePowerup = false;
    ...
    // Pierce Shot
    if (inShop && s_menuSelection === 4 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 1000)) {
        s_coins -= 1000;
        s_firePowerup = false;
        s_noPowerup = false;
    ...
    // Warp to Alien Base
    if (inShop && s_menuSelection === 5 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 2000)) {
        s_coins -= 2000;
        currentLevel = 0;
        m_purchase.play()
    }
    ...
    // Warp to Level 3
    if (inShop && s_menuSelection === 6 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 3000)) {
        s_coins -= 3000;
        currentLevel = 1;
        m_purchase.play()
    }
    ...
    // Warp to Level 4
    if (inShop && s_menuSelection === 7 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && !(s_coins < 4000)) {
        s_coins -= 4000;
        currentLevel = 2;
        m_purchase.play()
    }
    ...
    // Double Jump
    if (inShop && s_menuSelection === 8 && (eatKey(KEY_JUMP) || eatKey(KEY_SHOOT)) && Player.MAX_JUMPS !== 3 && !(s_coins < Player.MAX_JUMPS * 1000)) {
